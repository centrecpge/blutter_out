...
import 'SmartSixthStep.dart';

class SmartFifthStep extends StatefulWidget {
  final String type;
  
  const SmartFifthStep({required this.type, super.key});

  @override
  State<SmartFifthStep> createState() => _SmartFifthStepState();
}

class _SmartFifthStepState extends State<SmartFifthStep> {
  ...
  void _nextStep() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SmartSixthStep(type: widget.type),
      ),
    );
  }
