...
import 'SmartFifthStep.dart';

class SmartFourthStep extends StatefulWidget {
  final String type;
  
  const SmartFourthStep({required this.type, super.key});

  @override
  State<SmartFourthStep> createState() => _SmartFourthStepState();
}

class _SmartFourthStepState extends State<SmartFourthStep> {
  ...
  void _nextStep() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SmartFifthStep(type: widget.type),
      ),
    );
  }
  ...
  String txtPercentSwitch() {
    ...
    return "${selectedImages.length} document(s) sélectionné(s)";
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Joignez les documents ou justificatifs supplémentaires nécessaires pour votre dossier.",
